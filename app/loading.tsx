    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 dark:bg-neutral-950">
            <div className="relative flex flex-col items-center">
                ...
                <div className="h-16 w-16 animate-bounce rounded-full bg-[#658C58] shadow-lg flex items-center justify-center">
                    <svg
                ...
                <div className="mt-8 flex flex-col items-center gap-2">
                    ...
                    <div className="flex items-center space-x-1">
                        <div className="aspect-square w-2 animate-pulse rounded-full bg-[#658C58] delay-75"></div>
                        <div className="aspect-square w-2 animate-pulse rounded-full bg-[#658C58] delay-150"></div>
                        <div className="aspect-square w-2 animate-pulse rounded-full bg-[#658C58] delay-200"></div>
                    </div>
